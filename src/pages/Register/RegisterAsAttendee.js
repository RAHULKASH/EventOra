    ...
    <main className='w-3/4'>
        ...
        <div className="flex gap-4 flex-row mb-6">
          ...
          <div className="flex gap-4 flex-row mb-6">
              ...
              <input type="password" id="password" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  focus:border-blue-500 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 dark:text-white focus:ring-blue-500 focus:border-blue-500 shadow-sm-light" required minLength="7" />
          </div>
